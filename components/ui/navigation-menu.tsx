...
function NavigationMenuLink({
  ...
  ...props
}: React.ComponentProps<typeof NavigationMenuPrimitive.Link> & { disableDefaultStyle?: boolean }) {
  const base = disableDefaultStyle
    ? ""
  ...
  return <NavigationMenuPrimitive.Link data-slot="navigation-menu-link" className={cn(base, className)} {...props} />;
}
